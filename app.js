...
//itemIds
const itemIds = fs.readFileSync('itemIds.txt').toString().replace(/\r\n/g,'\n').split('\n');
...
app.get('/drawing', (req, res) => {
  ...
  res.render('main/drawing',{itemIds: itemIds});
});
...
const server = new WebSocket.Server({ port: 5002, host: '192.168.0.10'});
